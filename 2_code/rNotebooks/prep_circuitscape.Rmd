...
save(study_area, file="1_data/manual/v_road_clip.rdata")  
...
pp_s_clip_clus<-clusterSF(pp_s_clip, set_units(t, m))

save(pp_s_clip_clus, file="3_pipeline/tmp/pp_s_clip_clus.rData")

## plot clustered pinchpoints
tmap_mode("plot")
...
m5<-
  ...
  tm_shape(pp_s_clip_clus)+
    tm_fill(col="group", palette = "Dark2", contrast = c(0.26, 1),alpha = 1, n= nrow(pp_s_clip_clus), legend.show = FALSE)+
  tm_borders(col = "#636363")
m5
